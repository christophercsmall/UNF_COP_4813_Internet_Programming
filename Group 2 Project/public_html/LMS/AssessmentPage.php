...
<!--========================================================Test Questions=====================================================================-->
					...
					<div id="submitScore" class="" style="display:none;">
					
						<form action="InsertUserScore.php" method="post">
						
							Your Score: <span id='pts'></span> <br/>
							<input id="scr" name="Score" type="text" value='' hidden />
							<input type="submit" value="Input Score" class="btn-success btn-lg" />
   ...
   <?php include 'Layout/Footer.php'; ?>
    ...
    <script>
        ...
        function gradeTest() {
            ...
            document.getElementById("submitScore").style.display = "";
			document.getElementById("pts").innerHTML = points;
			document.getElementById("scr").value = points;
        }
